...
export const features = [
    ...
    },
    {
        ...
        paragraph:'Stop jumping from one service to another to communicate, sto files,  track tasks and share documents. Manage offers an all-in-one team  productivity solution.'
    }
];
